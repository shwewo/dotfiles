{ stable, inputs, config, pkgs, lib, ... }:
  ...
  socksed = [
    ...
    { name = "socks-v2ray-moldova";  script = "ss-local -c /run/agenix/socks_v2ray_moldova"; } # port 1081
    { name = "socks-v2ray-turkey";   script = "ss-local -c /run/agenix/socks_v2ray_turkey"; } # port 1082
    { name = "socks-v2ray-canada";   script = "ss-local -c /run/agenix/socks_v2ray_canada"; } # port 1083
    { name = "socks-v2ray-france";   script = "ss-local -c /run/agenix/socks_v2ray_france"; } # port 1084
